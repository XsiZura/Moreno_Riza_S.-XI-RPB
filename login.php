                        ...
                        <div class="card-body p-5 text-center">
                            <form action="" method="post">
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <h2 class="fw-bold mb-2 mb-3 text-uppercase">Login Ke RenZ Store</h2>
                                    ...
                                    <button class="btn btn-outline-light btn-lg px-5 mb-3" type="submit" name="btnlogin">Login</button><br>
